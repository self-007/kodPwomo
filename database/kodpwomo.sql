...
INSERT INTO `black_list` (`id`, `id_user`, `access_token`, `date`) VALUES
...
INSERT INTO `support` (`id`, `idUser`, `subject`, `category`, `message`, `date`, `university_id`) VALUES
(1, 'GOOGLE_hwoiP9nzChbWi7TClQnLWlhlKqy1', 'any', 'Commande', 'kib', '2025-12-12 22:01:10', 3);
...
INSERT INTO `users` (`id`, `name`, `firstname`, `email`, `phone`, `password`, `id_unique`, `otp`, `otpExp`, `access_token`, `id_university`, `role`, `status`, `code`, `date`, `refresh_token`, `is_verified`) VALUES
(1, 'Mukendi', 'Jean', 'jean.mukendi@unikin.ac.cd', '', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'USR001', 0, 0, 'fp_jean_123', 1, 'adm', 'active', '', '2025-09-15 08:00:00', 'refresh_token_jean', 0),
(2, 'Kabongo', 'Marie', 'marie.kabongo@upn.ac.cd', '', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'USR002', 0, 0, 'fp_marie_456', 1, 'agent', 'active', '', '2025-09-14 10:30:00', 'refresh_token_marie', 0),
