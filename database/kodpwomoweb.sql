...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : mer. 19 nov. 2025 à 00:53
...
CREATE TABLE IF NOT EXISTS `code` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=10001 DEFAULT CHARSET=utf8mb3;

--
-- Déchargement des données de la table `code`
--

INSERT INTO `code` (`id`, `order_code`, `status`) VALUES
(1, '0000', ''),
(2, '0001', ''),
(3, '0002', ''),
(4, '0003', ''),
...
INSERT INTO `notifications` (`id`, `id_user`, `type`, `message`, `status`, `link`, `calls`, `date`) VALUES
(1, 'USR001', 'commande', 'Votre commande #1 a été confirmée', 'read', '', 0, '2025-09-16 11:00:00'),
...
(7, 'GOOGLE_hwoiP9nzChbWi7TClQnLWlhlKqy1', 'commande', 'Votre commande #5 a été confirmée', '', '', 2, '2025-09-18 18:30:00'),
...
(11, 'GOOGLE_hwoiP9nzChbWi7TClQnLWlhlKqy1', 'delivery_feedback', 'enfin', 'read', '', 1, '2025-11-04 22:55:54'),
(12, 'GOOGLE_hwoiP9nzChbWi7TClQnLWlhlKqy1', 'delivery_feedback', 'done', 'unread', '', 2, '2025-11-08 19:20:34');
...
(1, 'ORD_0303', 'GOOGLE_hwoiP9nzChbWi7TClQnLWlhlKqy1', 1, 2500, 2, 'completed', 1, '2025-10-02 20:25:00'),
(2, 'ORD_0303', 'GOOGLE_hwoiP9nzChbWi7TClQnLWlhlKqy1', 3, 1000, 1, 'completed', 1, '2025-10-02 20:25:00'),
(3, 'ORD_0303', 'GOOGLE_hwoiP9nzChbWi7TClQnLWlhlKqy1', 2, 4000, 1, 'completed', 1, '2025-10-02 20:25:00'),
(4, 'ORD_0303', 'GOOGLE_hwoiP9nzChbWi7TClQnLWlhlKqy1', 4, 1500, 3, 'completed', 1, '2025-10-02 20:25:00'),
...
INSERT INTO `products` (`id`, `id_category`, `name`, `picture`, `prices`, `description`, `id_university`, `is_available`) VALUES
(1, 1, 'Sandwich Jambon-Fromage', 'image\\sandwich.jpeg', 25000, 'Délicieux sandwich avec jambon et fromage frais', 1, 1),
(2, 1, 'Riz au Poulet', 'image\\riz_poulet.jpeg', 4000, 'Riz parfumé avec morceaux de poulet grillé', 1, 1),
(3, 1, 'Coca-Cola 33cl', 'image\\coca.jpeg', 1000, 'Boisson gazeuse rafraîchissante', 1, 1),
(4, 2, 'Eau Minérale 50cl', 'image\\eau.jpeg', 500, 'Eau pure et rafraîchissante', 1, 1),
(5, 3, 'Cahier 200 pages', 'image\\cahier.jpeg', 1500, 'Cahier à spirale pour cours', 2, 0),
(6, 3, 'Stylo Bic Bleu', 'image\\stylo.png', 300, 'Stylo à bille de qualité', 2, 0),
(7, 1, 'Pizza Margherita', 'image\\pizza.jpeg', 6000, 'Pizza traditionnelle tomate-mozzarella', 3, 0),
(8, 4, 'T-shirt Uni', 'tshirt.jpg', 8000, 'T-shirt 100% coton, différentes couleurs', 1, 1),
...
(1, 'Amphithéâtre', 'prod_68fd4ad41ff714.98105599.jpg', 1),
(2, 'Salle 101', 'salle101.jpg', 1),
(3, 'Laboratoire Info', 'lab_info.jpg', 2),
(4, 'Bibliothèque', 'caf.jpg', 4),
(5, 'Cafétéria', 'caf.jpg', 1),
(6, 'jhon doe', 'prod_68fcebe665a9a9.57361238.jpeg', 1),
(7, 'Voltaire000', 'prod_68fd09ce660eb7.10315972.jpg', 1);
...
INSERT INTO `users` (`id`, `name`, `firstname`, `email`, `password`, `id_unique`, `otp`, `otpExp`, `finger_print`, `id_university`, `role`, `status`, `code`, `date`, `refresh_token`, `is_verified`) VALUES
...
(2, 'Kabongo', 'Marie', 'marie.kabongo@upn.ac.cd', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'USR002', 0, 0, 'fp_marie_456', 1, 'client', 'active', '', '2025-09-14 10:30:00', 'refresh_token_marie', 0),
...
(6, 'Bill James-sky Voltaire', 'Bill', 'voltairebilljamesky@gmail.com', '', 'GOOGLE_hwoiP9nzChbWi7TClQnLWlhlKqy1', 0, 0, 'ZGF0YTppbWFnZS9wbmc7YmFzZTY0LGlW', 1, 'agent', 'inactive', '', '2025-09-29 19:36:03', 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpYXQiOjE3NTkxNzQ1NjMsImV4cCI6MTc2MDM4NDE2Mywic3ViIjoiR09PR0xFX2h3b2lQOW56Q2hiV2k3VENsUW5MV2xobEtxeTEiLCJyb2xlIjoidXNlciJ9.GMayOvj0XwMmst6pY6u5D8xgx99Fkbbs3uvNCCFlq60', 0),
